...
public class SequencePrinter {
	...
	//Nombres de las imágenes de las tarjetas en orden de tablero
	...
	//Nombres de las cartas en orden de tablero
	static String[][] cards = {
	...
	static void findACard(String s) {
		//Encuentra la carta representada por String s 
		//e imprime sus dos ubicaciones en la pizarra
	...
	static void cardsInNaturalOrder() {
            /*
            Imprime cada fila de las cartas en cuatro palos
            Se utiliza para crear una matriz
            */
		for(int i=1; i<14; i++) {
			String s;
	...
	public static void main(String[] args) {
		...
		/*array de ImageIcons no lo utilize mas
		String[][] cardImages = {
				{"corner.png", "AC.png", "KC.png", "QC.png", "10C.png", "9C.png", "8C.png", "7C.png", "6C.png", "corner.png"},
				{"AD.png", "7S.png", "8S.png", "9S.png", "10S.png", "QS.png", "KS.png", "AS.png", "5C.png", "2S.png"},
				{"KD.png", "6S.png", "10C.png", "9C.png", "8C.png", "7C.png", "6C.png", "2D.png", "4C.png", "3S.png"},
